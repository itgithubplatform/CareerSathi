...
import { User, Target, BookOpen, TrendingUp, Award, Calendar, LogOut, CheckCircle, Circle } from 'lucide-react'
import toast from 'react-hot-toast'
import Header from '@/components/layout/Header'
import { getRandomGreeting, recommendedJobs } from '@/lib/constants'
    ...
    <>
      ...
      >
        <div>
          ...
          <p className="text-gray-600 ml-1">Let’s make today productive 🚀</p>
        </div>
      </motion.div>
